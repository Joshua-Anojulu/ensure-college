...
- The scholarship dataset is a **curated set** (184 scholarships, including a small school-specific pilot), and the summer-program dataset is a **curated set** (42 programs), not a comprehensive directory.
